...
// // WAF to solve book allocation problem.arr={2,1,3,4},n=4,m=2;
// #include<iostream>
// #include<vector>
// using namespace std;

// bool isValied(vector<int> arr, int n, int m, int maxAllocatedPages){
...
// //WAF to solve painter's partition problem. arr={40,30,10,20}, n=4, m=2.
// #include<iostream>
// #include<vector>
// #include<climits>
// using namespace std;
...
// int minTimeToPainter(vector<int> arr, int n, int m){
//     int maxVal=INT_MIN;
//     int sum=0;
//     for(int i=0; i<n; i++){
//         sum+=arr[i];
